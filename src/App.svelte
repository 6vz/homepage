    ...
    {#if loaded}
        <div class="position-absolute top-50 start-50 translate-middle" id="box" transition:fade>
            ...
            <div class="container whatsize text-center">
                <div class="row">
                    <button on:click|once={() => (window.location.href = 'https://www.google.com/search?q=' + document.getElementById('search-bar').value)}>
                    ...
                    <button on:click|once={() => (window.location.href = 'https://duckduckgo.com/?q=' + document.getElementById('search-bar').value)}>
                    ...
                    <button on:click|once={() => (window.location.href = 'https://perplexity.ai/search?q=' + document.getElementById('search-bar').value)}>
