...
<script lang="ts">
  ...
  let welcome = ["How's your [] going?","Today it's a beautiful []","[] - great day for surfing the web","How's your [] treating you?","Today it's a beautiful [] afternoon.","[] - great day for catching up on work emails.","How's your [] going so far?","Today it's a beautiful [] morning.","[] - great day for lazy Netflix binging.","How's your [] shaping up?","Today it's a beautiful [] evening.","[] - great day for running errands.","How's your [] looking?","Today it's a beautiful [] sunset.","[] - great day for starting fresh."]
